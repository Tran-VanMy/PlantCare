  ...
  const renderMenu = () => {
    ...
    switch (user.role_id) {
      ...
      case 2: // STAFF
        return (
          <nav className="flex gap-4">
            <Link to="/staff/dashboard" className="hover:text-green-600">Staff Dashboard</Link>
            <Link to="/staff/tasks" className="hover:text-green-600">Tasks</Link>
          </nav>
        );
      ...
      case 1: // ADMIN
        return (
          <nav className="flex gap-4">
            <Link to="/admin/dashboard" className="hover:text-green-600">Admin Dashboard</Link>
            <Link to="/admin/users" className="hover:text-green-600">Users</Link>
            <Link to="/admin/services" className="hover:text-green-600">Services</Link>
